...
- After each listing batch, send a PDF of 4×4" thermal SKU labels: bold SKU
  on top, then title, then listing date (`06-label-printer/make_labels.py`).
  Listing date = Nifty `createdAt`.
